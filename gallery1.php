...
<!-- section 3 -->
  ...
  <div class="cardm-container">
    <div class="cardm">
      <p class="cardm-text">I</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1633977334114-3c912e72daef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80" alt="spooky jack-o-lantern">
    </div>
    <div class="cardm">
      <p class="cardm-text">hope</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1601299570740-380e5ae4daa0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80" alt="hocus pocus decor">
    </div>
    <div class="cardm">
      <p class="cardm-text">you</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1604149370100-2cf3be3bc845?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" alt="spider web">
    </div>
    <div class="cardm">
      <p class="cardm-text">have</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1633977334114-3c912e72daef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80" alt="spooky jack-o-lantern">

    </div>
     <div class="cardm">
       <p class="cardm-text">a</p>
       <img class="cardm-img" src="https://images.unsplash.com/photo-1601299570740-380e5ae4daa0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80" alt="hocus pocus decor">
    </div>
    <div class="cardm">
      <p class="cardm-text">safe</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1604149370100-2cf3be3bc845?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" alt="spider web">
    </div>
     <div class="cardm">
       <p class="cardm-text">and</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1573306533578-12e23afbf2c6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80" alt="jack-o-lantern scarecrow">
    </div>
    <div class="cardm">
      <p class="cardm-text">spooky</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1601299570740-380e5ae4daa0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80" alt="hocus pocus decor">
    </div>
     <div class="cardm">
       <p class="cardm-text">Halloween!</p>
      <img class="cardm-img" src="https://images.unsplash.com/photo-1597739239353-50270a473397?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80" alt="spooky street at night">
    </div>
  </div>
