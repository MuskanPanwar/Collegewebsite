...
<div class="container-fluid m-0 p-0 header-img">
  <nav aria-label="breadcrumb" class="breadcrumb-img">
    ...
    <ol class="breadcrumb text-white">
      ...
      <li class="breadcrumb-item active text-white" aria-current="page"><span>ECE Department</span></li>
    </ol>
  </nav>
...
<div class="container-fluid py-3 text-justify">
  <div class="container-fluid">
    ...
    <p class="pera-justify px-lg-5 px-2">Electronics and communication engineering (ECE) is a discipline of engineering that involves developing and testing electronic circuits and communication devices like transmitters, receivers and integrated circuits</p>
  </div>
