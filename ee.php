...
<div class="container-fluid m-0 p-0 header-img">
  <nav aria-label="breadcrumb" class="breadcrumb-img">
    ...
    <ol class="breadcrumb text-white">
      ...
      <li class="breadcrumb-item active text-white" aria-current="page"><span>Electrical Department</span></li>
    </ol>
  </nav>
...
<div class="container-fluid py-3 text-justify">
  <div class="container-fluid">
    ...
    <p class="pera-justify px-lg-5 px-2">Electrical engineering is an engineering discipline concerned with the study, design, and application of equipment, devices, and systems which use electricity, electronics, and electromagnetism. </p>
  </div>
